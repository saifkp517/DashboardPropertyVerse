  ...
  return (
    ...
    <div className="">
      ...
      <div className="grid grid-cols-1">
        ...
        <div className="">
          <form onSubmit={submitHandler} className=" mt-14 mx-auto">
        ...
        <div className="border h-screen overflow-y-auto bg-white lg:h-5/6 border-black shadow-[inset_0_6px_10px_rgba(0,0,0,0.3)] rounded-lg my-10 p-3">
